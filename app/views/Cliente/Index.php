                            ...
                            <?php foreach ($lista as $cliente) {?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="javascript:;" onclick="excluir(this)" data-entidade="cliente" data-id="<?php echo $cliente->id_cliente ?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i> Excluir</a>
                                    </td>
				</tr> 	             
                            <?php } ?>					                   
