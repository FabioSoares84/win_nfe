					...
					<div class="caixa bg-cinza">
						<div class="rows p-4">
							<div class="col-6 mb-3 position-relative">
									 ...
									 <select id="id_produto"  class="form-campo" onchange="buscarProduto()">
							...
							<div class="col-2 mt-4  mt-sm-4">
                                ...
                                <input type="button" value="Inserir" onclick="inserirProduto()" class="btn btn-verde width-100">
							</div>                                                                                                                    
						</div>
					</div>				
					<div class="tabela-responsiva border p-0">
						...
						<tbody id="lista_itens">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a href="javascript:;" onclick="return excluir_item(this)" data-entidade ="itemvenda" data-id="1" class="fas fa-trash-alt text-vermelho"> Excluir</a> </td>
                                </tr>
						...
						<footer class="caixa-rodape text-right"> 
								<a href="javascript:;" onclick="" class="btn btn-amarelo d-inline-block"><i class="fas fa-broom"></i> Excluir Itens</a>
								<a href="javascript:;" onclick="" class="btn btn-vermelho d-inline-block"><i class="fas fa-trash"></i> Excluir Venda</a>
								<a href="" class="btn btn-verde d-inline-block"><i class="fas fa-check"></i> Finalizar Venda</a>
						</footer>
					</div>
                </div>   
            </div>
