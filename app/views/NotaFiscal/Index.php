						...
						<table cellpadding="0" cellspacing="0" id="dataTable">
                            ...
                            ?>                      
								<tr>
									...
									<td align="center"><?php echo $nota->em_xNome ?></td>
									
									<td align="center">
										<a href="<?php echo URL_BASE . "nfe/gerar/" .$nota->id_nfe ?>" class="d-inline-block btn btn-outline-verde btn-pequeno"><i class="fas fa-edit"></i> Gerar NFE</a>
